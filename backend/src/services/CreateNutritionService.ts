...
class CreateNutritionService {
    async execute({ name, age, weight, height, gender, level, objective }: DataProps) {

        try {
            // Colocamos o ponto de exclamação para garantir que o Typescript saiba que aqui tem uma chave e não acuse o erro.
